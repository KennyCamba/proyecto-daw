    ...
    render(){
        return(
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <a className="navbar-brand" href="ww">Centro internacional para la reducción de riesgos y desastres</a>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul className="navbar-nav mr-auto nav justify-content-end">
                        ...
                        <li class="nav-item dropdown">
                            <a className="nav-link dropdown-toggle" href="w" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Dropdown
                            </a>
                        ...
                        <li className="nav-item">
                            <a className="nav-link disabled" href="w">Disabled</a>
                        </li>
                    </ul>
                </div>
            </nav>
